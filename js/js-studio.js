...
let listCharF = [
    ...
    { 
        ...
        es: 'Одной из его уникальных способностей является возможность превращаться в нечто и питаться кровью. В процессе превращения у него появляются хвост-стрелочка и небольшие рожки, типичные для его сверхъестественной расы.',
    ...
    },
    {
        ...
        opn: 'Все три облика различаются. Первый более серьезный и задумчивый, второй - весёлый и активный, третий - просто спокойный. Все ± рассудительны. Если вы проявите к ним доброжелательность, они будут относиться к вам хорошо. Их действия мотивированы советами и последними словами покойной матери. Они ценят безопасность, чай, мир и уплату налогов.',
        ...
        es: 'Арт способен контролировать и душу, и разум, встроиться в мозг и пробыть там продолжительное время. Он может создавать тёмные камни и разнообразное оружие из них. Отлично владеет двуручным мечом. Способен воскрешать себя, изменяя облик. Также способен воскрешать других.',
